                        ...
                        seeListBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                try {
                                    ...
                                    dialog2.callFunction("[모두에게] 나의 리스트","확인", myListJSONArray);
                                    dialog2.show();
...
//                Goto(deviceID, deviceToken, ReadListActivity.class, "distanceList");
                ...
                String title = "준비중";
                String content = "2020년 1월 30일 업데이트 예정 입니다";
                String pos = "확인";
                String neg = "취소";

                final $Dialog_Custom_01 dialog = new $Dialog_Custom_01(LoungeActivity.this);
                dialog.callFunction(title, content, pos, neg);
...
//                    return;
                    ...
                    String title = "권한";
                    String content = "권한을 허용하지 않으면 몇몇 기능을 사용 할 수 없습니다.";
                    String pos = "확인";
                    String neg = "취소";
                    ...
                    dialog.show();
//                    Toast.makeText(LoungeActivity.this, "permission DENY", Toast.LENGTH_LONG).show();
                }
//                return;
                break;
        }
