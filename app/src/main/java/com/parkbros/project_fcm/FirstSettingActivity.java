        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ageEditText.getText().toString().trim().isEmpty()){
                    final $Dialog_Custom_01 dialog01 = new $Dialog_Custom_01(FirstSettingActivity.this);
                    String title = "오류";
                    String content = "작성하지 않은 정보가 존재합니다.";
                    dialog01.callFunction(title, content, "확인", "취소");
                    dialog01.getPosBtn().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            dialog01.dismiss();
                        }
                    });
                    dialog01.getNegBtn().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            dialog01.dismiss();
                        }
